...
export function LampDemo() {
  ...
  const getDeadTime = () => {
    return new Date("2024-11-08T00:00:00+05:30"); // 8th November 2024, 00:00:00 IST
  };
                  ...
                  <div className="box">
                    <div className="abs_abs">
                      <strong>
                        ...
                        <p>
                          Scheduled for the 8th and 9th of May, 2024, this event
                          showcases nine unique competitions, each designed for
                          individual or team participation.{" "}
                        </p>
                        <p>
                          In addition to the competitions, Anokhya offers a
                          series of workshops and technical talks delivered by
                          industry experts. Anokhya aims to foster innovation
                          and skill development among students, making it a
                          cornerstone event for budding technologists and
                          engineers.
                        </p>
                      </strong>{" "}
                    </div>
