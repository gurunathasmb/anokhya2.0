      ...
      <div className="maintimeline">
        <div className="maincontainer left-container">
          ...
          <div data-aos="fade-right" className="text-box lt">
            ...
            <small>8th November 9:00 to 10:00</small>
            <p>
        ...
        <div className="maincontainer right-container">
          ...
          <div data-aos="fade-left" className="text-box rt">
            ...
            <small>16th May 16:00 to 18:00</small>
            <p>
              Explore imagery at Picture Probe! Embark on a visual journey and
        ...
        <div className="maincontainer left-container">
          ...
          <div data-aos="fade-right" className="text-box lt">
            ...
            <small>16th May 16:00 to 18:00</small>
            <p>
              Participate in the excitement at PC Building! Dive into the event
              and craft your perfect machine from scratch.
            </p>
            <span className="left-container-arrow"></span>
          </div>
        </div>
        ...
        <div className="maincontainer right-container">
          ...
          <div data-aos="fade-left" className="text-box rt">
            ...
            <p>
              Engage with knowledge at Tech Talk! Immerse yourself in
              enlightening discussions and cutting-edge insights.
            </p>
            <span className="right-container-arrow"></span>
          </div>
        </div>
        ...
        <div className="maincontainer left-container">
          ...
          <div data-aos="fade-right" className="text-box lt">
            ...
            <p>
              Race to the code at CodeRelay! Join the fast-paced event and
              conquer programming challenges together!
            </p>
        ...
        <div className="maincontainer right-container">
          ...
          <div data-aos="fade-left" className="text-box rt">
            ...
            <p>
              Discover connections at Tech Tinder! Engage in tech conversations
              and spark innovative collaborations.
            </p>
            <span className="right-container-arrow"></span>
          </div>
        </div>
        ...
        <div className="maincontainer left-container">
          ...
          <div data-aos="fade-right" className="text-box lt">
            ...
            <p>
              Join us for an adrenaline-pumping gaming event centered around the
              popular tactical shooter, Valorant!{" "}
            </p>
            <span className="left-container-arrow"></span>
          </div>
        </div>
        ...
        <div className="maincontainer right-container">
          ...
          <div data-aos="fade-left" className="text-box rt">
            ...
            <small>9th November 15:00 to 17:00</small>
            <p>
